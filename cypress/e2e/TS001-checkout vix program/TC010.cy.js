...
Cypress.Commands.add('login', () => {
  ...
  /*TC0010 - User checkout program with invalid promo or referral*/
  
  it('User checkout program with invalid promo or referral', function () {
    //call login function
    cy.login()
    ...
    //click pakai promo atau referal button
    cy.get('[data-cy=choose-coupon]').click()
    document.querySelector("body > div:nth-child(9) > div > div.ant-modal-wrap > div > div.ant-modal-content > div > div.sc-hUgeJs.cfvtGq > div.sc-kSEogv.bNnZvd > p")
    
    //verify diskon pop up is shown
    cy.get('body > div:nth-child(9) > div > div.ant-modal-wrap > div > div.ant-modal-content > div > div:nth-child(1) > div:nth-child(1) > p').should('exist')
    
    cy.get('body > div:nth-child(9) > div > div.ant-modal-wrap > div > div.ant-modal-content > div > div:nth-child(3) > div > div > div > p').click()
    //verify diskon virtual internship pop up is shown
    cy.get('body > div:nth-child(9) > div > div.ant-modal-wrap > div > div.ant-modal-content > div > div:nth-child(1) > div:nth-child(1) > p').should('exist')

    //input promo/referal code
    cy.get('[data-cy=input-field-referral').type('TEST')
    cy.get('[data-cy=apply-referral-button]').click()

    //verify error message is shown
    cy.get('[data-cy=referral-error-container]').should('exist')
