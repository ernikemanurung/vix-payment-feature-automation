...
Cypress.Commands.add('login', () => {
  ...
  it('User checkout program with VIP Access and Point VIP Access', function () {
    //call login function
    cy.login()
    ...
    //click Gunakan VIP Access Point button
    cy.get('#root > div:nth-child(1) > div:nth-child(2) > div > div:nth-child(3) > div:nth-child(3) > div').click()
